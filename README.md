...
|  [JimAndTheOrders](https://www.hackerrank.com/challenges/jim-and-the-orders/problem) | [Solved](https://github.com/mughees-asif/hackerrank-solved-challenges/blob/master/algorithms/JimOrders/src/com/mughees/Main.java) | :green_book: | use two lists -> one for the result of the addition and the other for the `minIndex` -> iterate over result list -> remove the min element and store index into another list |
