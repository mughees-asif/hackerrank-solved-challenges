...
|  [Lisa'sWorkbook](https://www.hackerrank.com/challenges/lisa-workbook/problem) | [Solved](https://github.com/mughees-asif/hackerrank-solved-challenges/blob/master/algorithms/LisaWorkbook/src/com/mughees/Main.java) | :green_book: |  Loop through an array and split each `arr[i]` to determine how many `i` elements fit on one page |
